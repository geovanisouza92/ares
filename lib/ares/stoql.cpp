...
namespace LANG_NAMESPACE
{
    namespace SyntaxTree
    {
        ...
        void
        QueryNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "Query =>" << endl;
        ...
        void
        QueryOriginNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "From =>" << endl;
        ...
        void
        QueryBodyNode::printUsing (ostream & out, unsigned d)
        {
        ...
        void
        WhereNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "Where =>" << endl;
        ...
        void
        JoinNode::printUsing (ostream & out, unsigned d)
        {
        ...
        void
        OrderingNode::printUsing (ostream & out, unsigned d)
        {
        ...
        void
        OrderByNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "Ordering =>" << endl;
        ...
        void
        GroupByNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "Grouping =>" << endl;
        ...
        void
        RangeNode::printUsing (ostream & out, unsigned d)
        {
            switch (rangeType) {
            case RangeType::Skip:
                TAB(d) << "Skiping =>" << endl;
        ...
        void
        SelectNode::printUsing (ostream & out, unsigned d)
        {
            TAB(d) << "Select =>" << endl;
