...
DECLARE_ENUM_START(Operation,Operator)
    ...
    DECLARE_ENUM_MEMBER(UnaryNewClass)
    ...
    DECLARE_ENUM_MEMBER(TernarySlice)
...
DECLARE_ENUM_NAMES_START(Operation)
    ...
    DECLARE_ENUM_MEMBER_NAME("UnaryNewClass")
